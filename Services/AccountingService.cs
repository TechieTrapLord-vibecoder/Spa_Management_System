...
public interface IAccountingService
{
    ...
    /// Handles: Service Revenue, Cash/AR, Inventory, COGS, Commission Expense
    /// </summary>
    Task CreateSaleJournalEntriesAsync(Sale sale, string paymentMethod, long? userId, long? appointmentId = null);
...
public class AccountingService : IAccountingService
{
    ...
    public async Task CreateSaleJournalEntriesAsync(Sale sale, string paymentMethod, long? userId, long? appointmentId = null)
    {
        ...
        if (serviceTotal > 0 || productTotal > 0)
        {
            ...
            revenueEntry.JournalEntryLines.Add(new JournalEntryLine
            {
                ...
                Debit = serviceTotal + productTotal,
                Credit = 0,
