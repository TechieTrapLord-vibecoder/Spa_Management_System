-- =====================================================
-- CLOUD DATABASE RESET & FRESH SEED SCRIPT
-- Spa Management System - MonsterASP Cloud DB
...
-- =====================================================
PRINT 'Deleting all data from Cloud DB...';
...
DBCC CHECKIDENT ('EmployeeAttendance', RESEED, 0);
...
-- 3.4 UserAccount with HASHED password (admin123)
...
SELECT 'Cloud DB reset successful!' AS Result, 
